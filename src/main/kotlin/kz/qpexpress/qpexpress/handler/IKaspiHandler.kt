...
interface IKaspiHandler {
    ...
    fun getPaymentStatus(paymentId: Long): KaspiDTO.KaspiResponse<KaspiDTO.ResponseData.PaymentStatusResponse>
    fun getPaymentDetails(paymentId: Long): KaspiDTO.KaspiResponse<KaspiDTO.ResponseData.PaymentDetailsResponse>
}